	...
	<view>
		...
		<view class="show_modal_area">
			...
			<view class="show_modal_footer">
				<button class="show_modal_footer_btn_left_a" @tap="showModalBtnA(1)">删除</button>
				<button class="show_modal_footer_btn_left_b" @tap="showModalBtnA(2)">取消</button>
				<button class="show_modal_footer_btn_left_c" @tap="showModalBtnA(3)">保存</button>
			</view>
		</view>
...
<style>
	...
	.show_modal_footer_btn_left_a{
		font-size: 25upx;
		width: 150upx;
		background: #cb2920;
		color: #ffffff;
	}
	.show_modal_footer_btn_left_b{
		font-size: 25upx;
		width: 150upx;
	}
	.show_modal_footer_btn_left_c{
		background: #FF7200;
		color: #FFFFFF;
		font-size: 25upx;
		width: 150upx;
